...
/*   Updated: 2024/05/27 14:24:47 by ycantin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    selective_init_push(t_stack **stack_a, t_stack **stack_b)
{
    t_stack *current;
    int median;
    int num_nodes;
...
void    new_sort(t_stack **stack_a, t_stack **stack_b)
{
    ...
    selective_init_push(stack_a, stack_b);
    sort_three(stack_a);
    current_b  = *stack_b;
    lowest_cost = *stack_b;
    while (current_b)                               //problem sorting after sort three
    {
        i = 0;
        ...
        move_lowest_b_to_top(stack_a, stack_b, low_cost);//moves lowest cost to top of stack_b
        move_head_of_a_to_target(stack_a, stack_b);
